...
const UserDropdown = () => {
  ...
  const logout = (e) => {
    ...
    setUser({ authenticated: false, data: {} });
    setPrintOrders([]);
    setWallet({});
    setOrganisation({});
