...
export const Pricing = ({
  ...
  description = "Overview of our base document print price for all intending users. Optional services incure additional services.",
  plans = null,
  primaryButtonText = "Buy Now",
  planDurations = [
    {
      text: "Less than 50 pages",
      switcherText: "Basic",
    },
    {
      text: "50 pages or more",
      switcherText: "Bulk",
    },
  ],
}) => {
  const defaultPlans = [
    {
      ...
      mainFeature: "For Unregistered Users",
      features: [
        "Document Tracking",
        "Defaulted to Pickup location",
        "Basic Assistance",
      ],
    },
    {
      durationPrices: ["2bpt", "1bpt"],
      mainFeature: "For wallet users",
      features: [
        "Document Tracking",
            ...
            <Plan key={index} featured={plan.featured}>
              <PlanHeader>
                <span className="priceAndDuration">
                  ...
                  <span className="slash"> / Page </span>
                </span>
                <span className="name">
